...
function KanbanBoard() {
    ...
    useEffect (() => {
        const fetchData = async () => {
            try {
                const columnsResponse = await axios.get(`https://mnmltodobackend.onrender.com/user/getColumnsByName/${username}`);
                ...
                if (columnsResponse.data) {
                    ...
                    const tasksResponse = await axios.get(`https://mnmltodobackend.onrender.com/user/getTasksByName/${username}`);
    ...
    function createNewColumn() {
        ...
        fetch("https://mnmltodobackend.onrender.com/addColumn", {
            method:"POST",
    ...
    function createTask(columnId: Id, backgroundColor: string, isNew: boolean) {
        ...
        // Send the new column information to the API endpoint
        fetch("https://mnmltodobackend.onrender.com/addTask", {
            method:"POST",
            headers:{"Content-Type":"application/json"},
    ...
    function deleteTask(id: Id) {
        ...
        // Send the new column information to the API endpoint
        fetch(`https://mnmltodobackend.onrender.com/deleteTaskById/${id}`, {
            method:"DELETE",
            headers:{"Content-Type":"application/json"}
    ...
    function updateTask(id: Id, content: string, backgroundColor: string) {
        ...
        // Send the new column information to the API endpoint
        fetch("https://mnmltodobackend.onrender.com/updateTasks", {
            method:"POST",
            headers:{"Content-Type":"application/json"},
    ...
    function deleteColumn(id: Id) {
        ...
        fetch(`https://mnmltodobackend.onrender.com/deleteColumnById/${id}`, {
            method:"DELETE",
            headers:{"Content-Type":"application/json"}
    ...
    function updateColumn(id: Id, title: string, isNew: boolean) {
        ...
        fetch("https://mnmltodobackend.onrender.com/updateColumns", {
            method:"POST",
            headers:{"Content-Type":"application/json"},
