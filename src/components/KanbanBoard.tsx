...
function KanbanBoard() {
    ...
    useEffect (() => {
        const fetchData = async () => {
            try {
                const columnsResponse = await axios.get(`http://54.176.145.60:80/user/getColumnsByName/${username}`);
                ...
                if (columnsResponse.data) {
                    ...
                    const tasksResponse = await axios.get(`http://54.176.145.60:80/user/getTasksByName/${username}`);
    ...
    function createNewColumn() {
        ...
        fetch("http://54.176.145.60:80/addColumn", {
            method:"POST",
    ...
    function createTask(columnId: Id, backgroundColor: string, isNew: boolean) {
        ...
        // Send the new column information to the API endpoint
        fetch("http://54.176.145.60:80/addTask", {
            method:"POST",
            headers:{"Content-Type":"application/json"},
    ...
    function deleteTask(id: Id) {
        ...
        // Send the new column information to the API endpoint
        fetch(`http://54.176.145.60:80/deleteTaskById/${id}`, {
            method:"DELETE",
            headers:{"Content-Type":"application/json"}
    ...
    function updateTask(id: Id, content: string, backgroundColor: string) {
        ...
        // Send the new column information to the API endpoint
        fetch("http://54.176.145.60:80/updateTasks", {
            method:"POST",
            headers:{"Content-Type":"application/json"},
    ...
    function deleteColumn(id: Id) {
        ...
        fetch(`http://54.176.145.60:80/deleteColumnById/${id}`, {
            method:"DELETE",
            headers:{"Content-Type":"application/json"}
    ...
    function updateColumn(id: Id, title: string, isNew: boolean) {
        ...
        fetch("http://54.176.145.60:80/updateColumns", {
            method:"POST",
            headers:{"Content-Type":"application/json"},
